...
public class jPanMantenimientoFacturas extends javax.swing.JPanel {
     ...
     */
    public jPanMantenimientoFacturas() {
        initComponents();
        llenarTablaFacturas();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Si se desea Eliminar una Factura se deberan eliminar todas");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, 360, -1));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        int num = Integer.parseInt(jTableFacturas.getValueAt(jTableFacturas.getSelectedRow(), 0).toString());

        try {
            Factura.eliminarFactura(num);
        } catch (Exception e) {
        ...
        llenarTablaFacturas(); //actualiza la tabla   
